...
from .utils import extract_chapter_name, get_common_opf_paths, normalize_path, should_skip_chapter
...
class EPUBExtractor:
    ...
    def _extract_toc(self):
        ...
        for item in root.findall(".//opf:item", ns):
            ...
            if href and item_id:
                manifest_items[item_id] = {"href": normalize_path(href), "media_type": media_type}
    ...
    def _save_metadata(self, output_dir):
        ...
        info_data = {
            ...
            "chapters": [
                {"order": ch["order"], "name": ch["name"], "original_filename": ch["original_filename"]}
