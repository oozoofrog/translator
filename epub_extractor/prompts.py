...
9. **한국어 문체 원칙**:
   - 서술문: "~습니다" 보다 "~다" 형태로 자연스럽게 (예: "조용히 다가갔다")
   - 대화문: 캐릭터에 맞는 존댓말/반말, 경어 등 한국적 표현 적극 활용
   - 일반 소설체: 현대 한국 소설에서 많이 사용되는 자연스러운 문장 표현 사용
   - 과도한 높임 표현 지양: 불필요한 "~습니다" 체 사용 자제
...
**반드시 한국어만 사용하여 번역하세요. 중국어, 일본어, 영어 등 다른 언어는 절대 사용하지 마세요.**
