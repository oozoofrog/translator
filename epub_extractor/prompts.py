...
9. **한국어 문체 원칙**:
   - 서술문: "~했다", "~였다" 등 표준 과거형 사용 (예: "조용히 다가갔다")
   - 구어체 지양: "~다네", "~지", "~단다", "~구나" 등 방언적 표현 사용 금지
   - 현대 소설체: 깔끔하고 정제된 한국어 문학 문체 사용
   - 일관된 어미: 서술문은 "~다" 체로 통일, 대화문은 캐릭터에 맞게
   - 자연스러운 한국어: 번역투가 아닌 한국인이 쓰는 자연스러운 문장
...
- 정제된 문학적 문체: "~다네", "~지" 등 구어체 절대 금지
- 표준 서술문: "~했다", "~였다", "~이었다" 등 정형화된 과거형 사용
